/**
 * @file test_c_solve_rc.c
 * @brief C test for Real-Complex solver (equivalent to solve_rc.F90)
 * 
 * This test program reproduces the functionality of the Fortran solve_rc.F90
...
void initialize_test_parameters(void) {
    ...
    printf("=== C Test: Real-Complex Solver ===\n");
    printf("Parameters:\n");
    printf("  ndim = %d\n", ndim);
    printf("  nz = %d\n", nz);
    printf("  nl = %d\n", nl);
...
void run_cg_r_test(void) {
    ...
    /* Initialize solver */
    komega_status_t status = komega_cg_r_init(solver, ndim, nl, nz, x, z_real, 
                                            itermax, threshold, 0);
 ...
 */
int main(void) {
    printf("C Komega Library - Real-Complex Solver Test\n");
    printf("==========================================\n\n");
